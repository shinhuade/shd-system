...
export async function loadCostModelForMonth(periodMonth: string, isLatest = false): Promise<LoadedCostModel> {
  ...
  const model = buildCostModel({
    ...
    production: {
      ...
      naturalGasUsageM3: production.naturalGasUsageM3,
      naturalGasAvgHeatingValue: production.naturalGasAvgHeatingValue,
      bottledGasUsageKg: production.bottledGasUsageKg,
